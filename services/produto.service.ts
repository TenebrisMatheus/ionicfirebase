import { Injectable } from '@angular/core'; // Faz a importação do Angular Firestore
import { AngularFirestore } from '@angular/fire/compat/firestore'; // Faz a importação da classe de entidade do Produto
...
export class ProdutoService {
  ...
  salvar(produto: Produto){
    // Condsidere a collection como uma espécie de tabela produtos
